...
export const info = {
    ...
    skills:
        {
            proficientWith: ['Javascript', 'React', 'Git', 'Github', 'Adobe Suite', 'Html5', 'Css3', 'Figma', 'Tailwind', 'Jquery'],
            exposedTo: ['Nodejs', 'Invision', 'Blender', 'Typescript']
        }
    ,
    hobbies: [
        {
    ...
    portfolio: [ 
        ...
        {
            title: "Zoo App",
            live: "https://www.figma.com/proto/DAe3W65MJc64DGrxr8fRsu/Zoo-App-UI-Design?node-id=194-10298&scaling=min-zoom&page-id=186%3A576&starting-point-node-id=238%3A1128&show-proto-sidebar=1",
